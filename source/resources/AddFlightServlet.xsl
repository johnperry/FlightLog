...
<center>
	...
	<table>
		...
		<tr>
			...
			<td>XC:</td>
			<td><input class="text" type="text" name="txc" value="{Flight/@txc}" tabindex="8"/></td>
		</tr>
		<tr>
			<td>Aircraft ID:</td>
			<td><input class="text" type="text" name="acid" value="{Flight/@acid}" tabindex="2"/></td>
			<td>Day:</td>
			<td><input class="text" type="text" name="tday" value="{Flight/@tday}" tabindex="9"/></td>
		</tr>
		<tr>
			<td>From:</td>
			<td><input class="text" type="text" name="from" value="{Flight/@from}" tabindex="3"/></td>
			<td>Night:</td>
			<td><input class="text" type="text" name="tnt" value="{Flight/@tnt}" tabindex="10"/></td>
		</tr>
		<tr>
			<td>To:</td>
			<td><input class="text" type="text" name="to" value="{Flight/@to}" tabindex="4"/></td>
			<td>Instrument:</td>
			<td><input class="text" type="text" name="inst" value="{Flight/@inst}" tabindex="11"/></td>
		</tr>
		<tr>
			<td>Landings:</td>
		...
		<tr>
			...
			<td>Hood:</td>
			<td><input class="text" type="text" name="hood" value="{Flight/@hood}" tabindex="13"/></td>
		</tr>
		<tr>
			<td>Tach Time:</td>
			<td><input class="text" type="text" name="tach" value="{Flight/@tach}" tabindex="7"/></td>
			<td>PIC:</td>
			<td><input class="text" type="text" name="pic" value="{Flight/@pic}" tabindex="14"/></td>
		</tr>
		<tr>
			<td/>
			<td/>
